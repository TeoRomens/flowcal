...
export const ThemeSelector: React.FC = () => {
  ...
  return (
    <fieldset className="flex p-0.5 rounded-lg border-solid border bg-background w-fit gap-1 items-center">
      <legend className="sr-only">Select a display theme:</legend>

      {/* Light Theme */}
      <span
        className={cn("w-[20px] h-[18px] grid place-items-center",
          theme === "light" ? "text-primary" : "text-gray-300 hover:text-primary",
      ...
      <span
        className={cn("w-[20px] h-[18px] grid place-items-center",
          theme === "dark" ? "text-primary" : "text-gray-300 hover:text-primary",
          "cursor-pointer rounded-lg transition-colors duration-200")}
      >
        <input
          aria-label="dark"
      ...
      <span
        className={cn("w-[20px] h-[18px] grid place-items-center",
          theme === "system" ? "text-primary" : "text-gray-300 hover:text-primary",
          "cursor-pointer rounded-lg transition-colors duration-200")}
      >
        <input
          aria-label="system"
